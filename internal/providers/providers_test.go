...
func TestAllProvidersRegistered(t *testing.T) {
	want := []string{"greenhouse", "lever", "ashby", "smartrecruiters", "workable", "recruitee", "teamtailor", "careerjet", "manatal", "phenom", "oracle", "remotive", "himalayas", "jobicy", "jobven", "jobspipe"}
	if len(All) != len(want) {
